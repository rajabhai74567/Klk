...
#define PAYLOAD_SIZE 1024       // 1 KB payload per packet
#define RANDOM_STRING_SIZE 999     // Size of each random string (7 characters)
#define DEFAULT_THREAD_COUNT 900  // Default thread count
#define EXPIRY_DATE "2035-3-30"    // Expiry date in YYYY-MM-DD format
...
void print_stylish_text() {
    printf("\n");
    printf("============================================\n");
    printf("       RAJA BHAI KA SYSTEM , BANARY DEVLOPER BY:\n");
    printf("            @RAJARAJ_04\n");
    printf("============================================\n");
    printf("       VALID TILL 12 February 2025\n");
    printf("============================================\n");
    printf("            AAGYA TERA BAAP BY:\n");
    printf("              RAJA BHAI\n");
    printf("============================================\n");
    printf("   YE FULL FREE DDOS BANARY HAI\n");
